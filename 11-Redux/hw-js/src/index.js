...
//---------------------------
//si tuvieramos más de un parámetro:
//let combined = combineReducer(r1, r2)
//2 store = createStore(combined)
...
//para que se ejecute ante cada cambio del estado renderContador()
